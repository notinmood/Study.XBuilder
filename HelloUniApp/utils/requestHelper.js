export class RequestHelper {
	 ...
	 * @param {String} url 请求的地址
	 * @param {Object} paramsObject 请求的参数
	 * @param {Object} optionsObject 请求的配置。配置项包括header等(如果内部设置了method，本方法会自动变更为GET)  
	 */
	static get(url, paramsObject = {}, optionsObject = {}) {
		optionsObject.method = 'GET';
		return this.request(url, paramsObject, optionsObject);
	}
	/**
	 * 封装POST请求
	 * @param {String} url 请求的地址
	 * @param {Object} paramsObject 请求的参数
	 * @param {Object} optionsObject 请求的配置。配置项包括header等(如果内部设置了method，本方法会自动变更为POST)
	 */
	static post(url, paramsObject = {}, optionsObject = {}) {
